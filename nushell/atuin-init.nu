# Local copy of Atuin's Nushell integration. Keep this copy under ~/.config so
# the keybinding names can remain unique with Nushell 0.115+.
module compat {
